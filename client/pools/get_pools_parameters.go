...
// bindParamGetPools binds the parameter not-tags
func (o *GetPoolsParams) bindParamNotTags(formats strfmt.Registry) []string {
	notTagsIR := o.NotTags
...
// bindParamGetPools binds the parameter not-tags-any
func (o *GetPoolsParams) bindParamNotTagsAny(formats strfmt.Registry) []string {
...
// bindParamGetPools binds the parameter tags
func (o *GetPoolsParams) bindParamTags(formats strfmt.Registry) []string {
	tagsIR := o.Tags
...
// bindParamGetPools binds the parameter tags-any
func (o *GetPoolsParams) bindParamTagsAny(formats strfmt.Registry) []string {
	tagsAnyIR := o.TagsAny
