...
// NewGetDatacentersDatacenterIDParamsWithTimeout creates a new GetDatacentersDatacenterIDParams object
...
// NewGetDatacentersDatacenterIDParamsWithContext creates a new GetDatacentersDatacenterIDParams object
...
// NewGetDatacentersDatacenterIDParamsWithHTTPClient creates a new GetDatacentersDatacenterIDParams object
...
func (o *GetDatacentersDatacenterIDParams) WithDefaults() *GetDatacentersDatacenterIDParams {
	o.SetDefaults()
	return o
}
...
func (o *GetDatacentersDatacenterIDParams) WithTimeout(timeout time.Duration) *GetDatacentersDatacenterIDParams {
...
func (o *GetDatacentersDatacenterIDParams) WithContext(ctx context.Context) *GetDatacentersDatacenterIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get datacenters datacenter ID params
func (o *GetDatacentersDatacenterIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get datacenters datacenter ID params
func (o *GetDatacentersDatacenterIDParams) WithHTTPClient(client *http.Client) *GetDatacentersDatacenterIDParams {
...
func (o *GetDatacentersDatacenterIDParams) WithDatacenterID(datacenterID strfmt.UUID) *GetDatacentersDatacenterIDParams {
...
func (o *GetDatacentersDatacenterIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
