...
func (o *GetDomainsParams) bindNotTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetDomainsParams) bindNotTagsAny(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetDomainsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetDomainsParams) bindTagsAny(rawData []string, hasKey bool, formats strfmt.Registry) error {
