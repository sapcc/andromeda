...
func (o *DeleteDomainsDomainIDURL) WithBasePath(bp string) *DeleteDomainsDomainIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteDomainsDomainIDURL) Build() (*url.URL, error) {
	...
	if domainID != "" {
		...
		return nil, errors.New("domainId is required on DeleteDomainsDomainIDURL")
	}
...
func (o *DeleteDomainsDomainIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteDomainsDomainIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteDomainsDomainIDURL")
	}
