...
func (o *GetDomainsDomainIDURL) Build() (*url.URL, error) {
	...
	if domainID != "" {
		...
		return nil, errors.New("domainId is required on GetDomainsDomainIDURL")
	}
...
func (o *GetDomainsDomainIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDomainsDomainIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDomainsDomainIDURL")
	}
