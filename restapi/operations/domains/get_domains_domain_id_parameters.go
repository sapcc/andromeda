...
// GetDomainsDomainIDParams contains all the bound params for the get domains domain ID operation
...
func (o *GetDomainsDomainIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDomainsDomainIDParams) bindDomainID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDomainsDomainIDParams) validateDomainID(formats strfmt.Registry) error {
