...
func (o *DeleteMonitorsMonitorIDURL) WithBasePath(bp string) *DeleteMonitorsMonitorIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteMonitorsMonitorIDURL) Build() (*url.URL, error) {
	...
	var _path = "/monitors/{monitor_id}"

	monitorID := o.MonitorID.String()
	if monitorID != "" {
		_path = strings.Replace(_path, "{monitor_id}", monitorID, -1)
	} else {
		return nil, errors.New("monitorId is required on DeleteMonitorsMonitorIDURL")
	}
...
func (o *DeleteMonitorsMonitorIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteMonitorsMonitorIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteMonitorsMonitorIDURL")
	}
