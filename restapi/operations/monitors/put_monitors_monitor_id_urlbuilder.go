...
func (o *PutMonitorsMonitorIDURL) WithBasePath(bp string) *PutMonitorsMonitorIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PutMonitorsMonitorIDURL) Build() (*url.URL, error) {
	...
	if monitorID != "" {
		...
		return nil, errors.New("monitorId is required on PutMonitorsMonitorIDURL")
	}
...
func (o *PutMonitorsMonitorIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutMonitorsMonitorIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutMonitorsMonitorIDURL")
	}
