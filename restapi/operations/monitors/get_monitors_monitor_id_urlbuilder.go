...
func (o *GetMonitorsMonitorIDURL) WithBasePath(bp string) *GetMonitorsMonitorIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetMonitorsMonitorIDURL) Build() (*url.URL, error) {
	...
	if monitorID != "" {
		...
		return nil, errors.New("monitorId is required on GetMonitorsMonitorIDURL")
	}
...
func (o *GetMonitorsMonitorIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetMonitorsMonitorIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetMonitorsMonitorIDURL")
	}
