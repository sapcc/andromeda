...
func (o *GetDatacentersParams) bindNotTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetDatacentersParams) bindNotTagsAny(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetDatacentersParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetDatacentersParams) bindTagsAny(rawData []string, hasKey bool, formats strfmt.Registry) error {
