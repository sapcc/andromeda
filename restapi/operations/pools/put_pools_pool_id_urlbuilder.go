...
func (o *PutPoolsPoolIDURL) Build() (*url.URL, error) {
	...
	if poolID != "" {
		...
		return nil, errors.New("poolId is required on PutPoolsPoolIDURL")
	}
...
func (o *PutPoolsPoolIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutPoolsPoolIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutPoolsPoolIDURL")
	}
