...
func (o *DeletePoolsPoolIDURL) Build() (*url.URL, error) {
	...
	if poolID != "" {
		...
		return nil, errors.New("poolId is required on DeletePoolsPoolIDURL")
	}
...
func (o *DeletePoolsPoolIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeletePoolsPoolIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeletePoolsPoolIDURL")
	}
