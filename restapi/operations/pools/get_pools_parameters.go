...
// GetPoolsParams contains all the bound params for the get pools operation
...
func (o *GetPoolsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPoolsParams) bindMarker(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPoolsParams) validateMarker(formats strfmt.Registry) error {
...
func (o *GetPoolsParams) bindNotTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetPoolsParams) bindNotTagsAny(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetPoolsParams) bindPageReverse(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetPoolsParams) bindSort(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetPoolsParams) bindTags(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var qvTags string
	if len(rawData) > 0 {
...
//
// Arrays are parsed according to CollectionFormat: "" (defaults to "csv" when empty).
func (o *GetPoolsParams) bindTagsAny(rawData []string, hasKey bool, formats strfmt.Registry) error {
