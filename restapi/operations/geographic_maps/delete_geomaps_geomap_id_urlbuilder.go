...
func (o *DeleteGeomapsGeomapIDURL) WithBasePath(bp string) *DeleteGeomapsGeomapIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteGeomapsGeomapIDURL) Build() (*url.URL, error) {
	...
	if geomapID != "" {
		...
		return nil, errors.New("geomapId is required on DeleteGeomapsGeomapIDURL")
	}
...
func (o *DeleteGeomapsGeomapIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteGeomapsGeomapIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteGeomapsGeomapIDURL")
	}
