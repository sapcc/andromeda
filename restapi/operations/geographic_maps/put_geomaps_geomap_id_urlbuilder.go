...
func (o *PutGeomapsGeomapIDURL) Build() (*url.URL, error) {
	...
	if geomapID != "" {
		...
		return nil, errors.New("geomapId is required on PutGeomapsGeomapIDURL")
	}
...
func (o *PutGeomapsGeomapIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutGeomapsGeomapIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutGeomapsGeomapIDURL")
	}
