...
func (o *PutMembersMemberIDURL) Build() (*url.URL, error) {
	...
	if memberID != "" {
		...
		return nil, errors.New("memberId is required on PutMembersMemberIDURL")
	}
...
func (o *PutMembersMemberIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutMembersMemberIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutMembersMemberIDURL")
	}
