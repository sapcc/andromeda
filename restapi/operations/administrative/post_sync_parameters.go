...
// PostSyncParams contains all the bound params for the post sync operation
...
func (o *PostSyncParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body PostSyncBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("domains", "body", ""))
			} else {
				res = append(res, errors.NewParseError("domains", "body", "", err))
			}
		} else {
