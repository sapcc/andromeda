...
func (o *PostSyncDomainIDURL) Build() (*url.URL, error) {
	...
	var _path = "/sync/{domain_id}"

	domainID := o.DomainID.String()
	if domainID != "" {
		_path = strings.Replace(_path, "{domain_id}", domainID, -1)
	} else {
		return nil, errors.New("domainId is required on PostSyncDomainIDURL")
	}
...
func (o *PostSyncDomainIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostSyncDomainIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostSyncDomainIDURL")
	}
