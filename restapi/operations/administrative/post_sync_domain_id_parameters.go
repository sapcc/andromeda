...
func NewPostSyncDomainIDParams() PostSyncDomainIDParams {
	...
	return PostSyncDomainIDParams{}
}

// PostSyncDomainIDParams contains all the bound params for the post sync domain ID operation
...
func (o *PostSyncDomainIDParams) bindDomainID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *PostSyncDomainIDParams) validateDomainID(formats strfmt.Registry) error {
