...
func (fn PostSyncDomainIDHandlerFunc) Handle(params PostSyncDomainIDParams) middleware.Responder {
	return fn(params)
}
...
func NewPostSyncDomainID(ctx *middleware.Context, handler PostSyncDomainIDHandler) *PostSyncDomainID {
	return &PostSyncDomainID{Context: ctx, Handler: handler}
}
...
func (o *PostSyncDomainID) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewPostSyncDomainIDParams()
